      ...
      <main>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div><span className="block font-serif text-4xl md:text-5xl mb-2">1200</span><span className="text-sm uppercase tracking-wider text-primary-foreground/70">m² property</span></div>
              <div><span className="block font-serif text-4xl md:text-5xl mb-2">3</span><span className="text-sm uppercase tracking-wider text-primary-foreground/70">leafy patios</span></div>
              <div><span className="block font-serif text-4xl md:text-5xl mb-2">9</span><span className="text-sm uppercase tracking-wider text-primary-foreground/70">distinct rooms</span></div>
              <div><span className="block font-serif text-4xl md:text-5xl mb-2">250</span><span className="text-sm uppercase tracking-wider text-primary-foreground/70">m² spa</span></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 md:py-28">
          <div className="container mx-auto px-4"><div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">A heated pool with views towards the Atlas</h2>
        ...
        <section className="py-20 md:py-28 bg-muted/30">
          <div className="container mx-auto px-4"><div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">Three patios, three atmospheres</h2>
        ...
        <section className="py-20 md:py-28">
          <div className="container mx-auto px-4"><div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">Arrive by car at our door</h2>
        ...
        <section className="py-20 md:py-28 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4"><div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-4xl mb-6">Privatise the riad for your event</h2>
