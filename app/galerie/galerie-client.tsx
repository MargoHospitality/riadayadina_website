...
const galleryCategories = [
  ...
  },
  {
    ...
    images: [
      { src: "/images/ayadina/piscine-jour-01.jpg", alt: "Piscine chauffée sur le toit" },
          ...
          <div className="relative z-10 container mx-auto px-4 text-center">
            <AnimateOnScroll animation="fade-up">
              ...
              <p className="text-white/90 text-lg max-w-2xl mx-auto">
                Patios, chambres, spa, terrasse : découvrez les lieux avant votre arrivée.
              </p>
            </AnimateOnScroll>
          </div>
        </section>
