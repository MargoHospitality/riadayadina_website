            ...
            <div className="max-w-lg">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  Ayadina est une maison de riad : une parenthèse de calme au cœur de Marrakech.
                </p>
              </div>
              ...
              <div className="flex items-center gap-8 mt-8 pt-8 border-t border-border/50">
                <div>
                  <p className="font-serif text-2xl text-foreground">1 200 m²</p>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground uppercase tracking-wider">chambres singulières</p>
                </div>
              </div>
            </div>
          </AnimateOnScroll>
